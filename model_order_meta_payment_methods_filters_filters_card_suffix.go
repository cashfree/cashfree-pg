...
// OrderMetaPaymentMethodsFiltersFiltersCardSuffix Allowed card suffixes for the order
type OrderMetaPaymentMethodsFiltersFiltersCardSuffix struct {
...
func (o OrderMetaPaymentMethodsFiltersFiltersCardSuffix) MarshalJSON() ([]byte, error) {
...
func (o OrderMetaPaymentMethodsFiltersFiltersCardSuffix) ToMap() (map[string]interface{}, error) {
