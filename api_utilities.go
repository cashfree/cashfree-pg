...
func (_this *Cashfree) PGCreatePAR(pARRequest *PARRequest,  xRequestId *string, xIdempotencyKey *string, httpClient *http.Client) (*PGCreatePAR200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/utilities/pars"
...
func (_this *Cashfree) PGGetCardBin(getCardBinRequest *GetCardBinRequest,  xRequestId *string, xIdempotencyKey *string, httpClient *http.Client) (*GetCardBinResponseSchema, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetCardBinResponseSchema
	)
	if _this.XEnableErrorAnalytics == nil {
		flag := false
		_this.XEnableErrorAnalytics = &flag
	...
	if *_this.XEnableErrorAnalytics {
		SetupSentry(*_this.XEnvironment)
		defer CaptureError("PGGetCardBin")
	}
	...
	localVarPath := localBasePath + "/utilities/cardbin"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if getCardBinRequest == nil {
		return localVarReturnValue, nil, reportError("getCardBinRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = getCardBinRequest
...
// Execute executes the request
//  @return GetCardBinResponseSchema
func (_this *Cashfree) PGGetCardBinWithContext(ctx context.Context, getCardBinRequest *GetCardBinRequest,  xRequestId *string, xIdempotencyKey *string, httpClient *http.Client) (*GetCardBinResponseSchema, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
