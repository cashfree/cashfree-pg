...
// checks if the ReconEntityDataInnerEventDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReconEntityDataInnerEventDetails{}

// ReconEntityDataInnerEventDetails struct for ReconEntityDataInnerEventDetails
type ReconEntityDataInnerEventDetails struct {
...
func (o ReconEntityDataInnerEventDetails) MarshalJSON() ([]byte, error) {
...
func (o ReconEntityDataInnerEventDetails) ToMap() (map[string]interface{}, error) {
