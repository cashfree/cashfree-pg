...
**IncidentEndTime** | Pointer to **NullableTime** | End time of the incident, or null if ongoing. | [optional] 
...
`func (o *IncidentObject) GetIncidentStartTime() time.Time`

GetIncidentStartTime returns the IncidentStartTime field if non-nil, zero value otherwise.

### GetIncidentStartTimeOk

`func (o *IncidentObject) GetIncidentStartTimeOk() (*time.Time, bool)`
...
`func (o *IncidentObject) SetIncidentStartTime(v time.Time)`
...
`func (o *IncidentObject) GetIncidentEndTime() time.Time`

GetIncidentEndTime returns the IncidentEndTime field if non-nil, zero value otherwise.

### GetIncidentEndTimeOk

`func (o *IncidentObject) GetIncidentEndTimeOk() (*time.Time, bool)`
...
`func (o *IncidentObject) SetIncidentEndTime(v time.Time)`
