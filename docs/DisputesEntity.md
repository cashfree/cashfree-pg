...
`func (o *DisputesEntity) GetPreferredEvidence() map[string]interface{}`

GetPreferredEvidence returns the PreferredEvidence field if non-nil, zero value otherwise.

### GetPreferredEvidenceOk

`func (o *DisputesEntity) GetPreferredEvidenceOk() (*map[string]interface{}, bool)`
...
`func (o *DisputesEntity) SetPreferredEvidence(v map[string]interface{})`
