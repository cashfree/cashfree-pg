...
> PGCreateOrder(xApiVersion *string, createOrderRequest *CreateOrderRequest,  xRequestId *string, xIdempotencyKey *string, httpClient *http.Client) (*OrderEntity, *http.Response, error)
...
```go
version := "2022-09-01"
response, httpResponse, err := cashfree.PGFetchOrder(&version, "order_3242Tq4Edj9CC5RDcMeobmJOWOBJij", nil, nil, nil)
if err != nil {
	fmt.Println(err.Error())
} else {
	fmt.Println(httpResponse.StatusCode)
