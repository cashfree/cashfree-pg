...
`func (o *LinkCustomerDetailsEntity) GetCustomerBankAccountNumber() string`
...
`func (o *LinkCustomerDetailsEntity) GetCustomerBankAccountNumberOk() (*string, bool)`
...
`func (o *LinkCustomerDetailsEntity) SetCustomerBankIfsc(v string)`

SetCustomerBankIfsc sets CustomerBankIfsc field to given value.

### HasCustomerBankIfsc

`func (o *LinkCustomerDetailsEntity) HasCustomerBankIfsc() bool`

HasCustomerBankIfsc returns a boolean if a field has been set.

### GetCustomerBankCode

`func (o *LinkCustomerDetailsEntity) GetCustomerBankCode() int32`

GetCustomerBankCode returns the CustomerBankCode field if non-nil, zero value otherwise.

### GetCustomerBankCodeOk

`func (o *LinkCustomerDetailsEntity) GetCustomerBankCodeOk() (*int32, bool)`
...
`func (o *LinkCustomerDetailsEntity) SetCustomerBankCode(v int32)`
