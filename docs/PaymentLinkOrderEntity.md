...
`func (o *PaymentLinkOrderEntity) GetCfOrderId() string`

GetCfOrderId returns the CfOrderId field if non-nil, zero value otherwise.

### GetCfOrderIdOk

`func (o *PaymentLinkOrderEntity) GetCfOrderIdOk() (*string, bool)`
...
`func (o *PaymentLinkOrderEntity) SetCfOrderId(v string)`
