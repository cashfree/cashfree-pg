...
------------ | ------------- | ------------- | -------------
**CfPaymentId** | Pointer to **string** | Payment entity full object. | [optional] 
...
**BankReference** | Pointer to **string** | Issuing bank’s transaction reference number. | [optional] 
**AuthId** | Pointer to **string** | Authorisation ID provided by the issuing bank. | [optional] 
