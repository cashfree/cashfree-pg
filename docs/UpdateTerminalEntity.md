...
`func (o *UpdateTerminalEntity) GetTerminalMeta() string`

GetTerminalMeta returns the TerminalMeta field if non-nil, zero value otherwise.

### GetTerminalMetaOk

`func (o *UpdateTerminalEntity) GetTerminalMetaOk() (*string, bool)`
...
`func (o *UpdateTerminalEntity) SetTerminalMeta(v string)`
