...
`func (o *CreateSubscriptionPaymentRequestPnach) SetAccountBankCode(v string)`
...
`func (o *CreateSubscriptionPaymentRequestPnach) GetMandateStartDateOk() (*string, bool)`
