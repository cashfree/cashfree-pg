...
> PGFetchRecon(xApiVersion *string, fetchReconRequest *FetchReconRequest,  contentType *string, xRequestId *string, xIdempotencyKey *string, accept *string, httpClient *http.Client) (*ReconEntity, *http.Response, error)
...
fetchReconRequest := cashfree.FetchReconRequest{
	Pagination: cashfree.FetchReconRequestPagination{
		Limit: 10,
		Cursor: &cursor,
	},
	Filters: cashfree.FetchReconRequestFilters{
		StartDate: "2022-07-20T00:00:00Z",
		EndDate:   "2022-07-21T23:59:59Z",
	},
}

fetchReconResponse, httpResponse, err := cashfree.PGFetchRecon(&version, &fetchReconRequest, &contentType, nil, nil, &contentType, nil)
if err != nil {
	fmt.Println(err.Error())
} else {
	fmt.Println(httpResponse.StatusCode)
	fmt.Println(fetchReconResponse)
}
```
