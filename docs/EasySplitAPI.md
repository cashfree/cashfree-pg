...
> VendorDocumentDownloadResponse PGESDownloadVendorsDocs(ctx, docType, vendorId).XRequestId(xRequestId).XIdempotencyKey(xIdempotencyKey).Execute()
...
func main() {
    ...
    resp, r, err := cashfree.PGESDownloadVendorsDocs(&docType, &vendorId, &xRequestId, &xIdempotencyKey, nil)
    if err != nil {
