...
**TokenRequestorId** | Pointer to **string** | TRID issued by respective card networks. | [optional] 
**CardNumber** | Pointer to **string** | Token number. | [optional] 
**CardExpiryMm** | Pointer to **string** | Token expiry month. | [optional] 
**CardExpiryYy** | Pointer to **string** | Token expiry year. | [optional] 
**Cryptogram** | Pointer to **string** | A one-time code dynamically generated by the respective card network, required to process saved card payments. | [optional] 
**CardDisplay** | Pointer to **string** | Displays the last four digits of the actual card number. | [optional] 
