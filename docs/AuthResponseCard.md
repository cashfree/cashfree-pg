...
`func (o *AuthResponseCard) SetChannelNil(b bool)`

 SetChannelNil sets the value for Channel to be an explicit nil

### UnsetChannel
`func (o *AuthResponseCard) UnsetChannel()`
