...
// checks if the PaymentGatewayDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentGatewayDetails{}

// PaymentGatewayDetails payment gateway details present in the webhook response
...
func (o PaymentGatewayDetails) MarshalJSON() ([]byte, error) {
...
func (o PaymentGatewayDetails) ToMap() (map[string]interface{}, error) {
