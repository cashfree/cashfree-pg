...
// checks if the LinkPlanEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkPlanEntity{}

// LinkPlanEntity subscription plan details for recurring payments
type LinkPlanEntity struct {
...
func (o LinkPlanEntity) MarshalJSON() ([]byte, error) {
...
func (o LinkPlanEntity) ToMap() (map[string]interface{}, error) {
