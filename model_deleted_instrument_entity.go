...
// checks if the DeletedInstrumentEntity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeletedInstrumentEntity{}

// DeletedInstrumentEntity Delete saved card instrument object.
type DeletedInstrumentEntity struct {
...
func (o DeletedInstrumentEntity) MarshalJSON() ([]byte, error) {
...
func (o DeletedInstrumentEntity) ToMap() (map[string]interface{}, error) {
