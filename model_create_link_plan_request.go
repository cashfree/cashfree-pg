...
// checks if the CreateLinkPlanRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateLinkPlanRequest{}

// CreateLinkPlanRequest Request body to create a plan.
...
func (o CreateLinkPlanRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateLinkPlanRequest) ToMap() (map[string]interface{}, error) {
