...
// checks if the PNACH type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PNACH{}

// PNACH payment method pnach.
type PNACH struct {
	// Channel. can be post
...
func (o PNACH) MarshalJSON() ([]byte, error) {
...
func (o PNACH) ToMap() (map[string]interface{}, error) {
