...
export interface EligibilityMethodItemEntityDetails {
     ...
     * @type {[]SubscriptionBankDetails}
     * @memberof EligibilityMethodItemEntityDetails
     */
    'frequent_bank_details'?: []SubscriptionBankDetails;
    /**
     * Details about all banks associated with the payment method.
     * @type {[]SubscriptionBankDetails}
     * @memberof EligibilityMethodItemEntityDetails
     */
    'all_bank_details'?: []SubscriptionBankDetails;
    /**
     * List of supported VPA handles.
     * @type {[]EligibilityMethodItemEntityDetailsAvailableHandlesInner}
     * @memberof EligibilityMethodItemEntityDetails
     */
    'available_handles'?: []EligibilityMethodItemEntityDetailsAvailableHandlesInner;
    /**
