...
func PGESDownloadVendorsDocs(docType string, vendorId string,  xRequestId *string, xIdempotencyKey *string, httpClient *http.Client) (*VendorDocumentDownloadResponse, *http.Response, error) {
	var (
...
// Execute executes the request
//  @return VendorDocumentDownloadResponse
func PGESDownloadVendorsDocsWithContext(ctx context.Context, docType string, vendorId string,  xRequestId *string, xIdempotencyKey *string, httpClient *http.Client) (*VendorDocumentDownloadResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
