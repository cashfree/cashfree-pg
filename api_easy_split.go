...
func PGESUploadVendorsDocs(xApiVersion *string, vendorId string,  docType *string, docValue *string, file *os.File, httpClient *http.Client) (*UploadVendorDocumentsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Execute executes the request
//  @return UploadVendorDocumentsResponse
func PGESUploadVendorsDocsWithContext(ctx context.Context, xApiVersion *string, vendorId string,  docType *string, docValue *string, file *os.File, httpClient *http.Client) (*UploadVendorDocumentsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
