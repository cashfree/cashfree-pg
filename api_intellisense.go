...
func (_this *Cashfree) FetchDowntimeById(id string,  httpClient *http.Client) (*IncidentByIdResponse, *http.Response, error) {
	var (
...
// Execute executes the request
//  @return IncidentByIdResponse
func (_this *Cashfree) FetchDowntimeByIdWithContext(ctx context.Context, id string,  httpClient *http.Client) (*IncidentByIdResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
