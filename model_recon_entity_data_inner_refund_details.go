...
// checks if the ReconEntityDataInnerRefundDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReconEntityDataInnerRefundDetails{}

// ReconEntityDataInnerRefundDetails struct for ReconEntityDataInnerRefundDetails
type ReconEntityDataInnerRefundDetails struct {
...
func (o ReconEntityDataInnerRefundDetails) MarshalJSON() ([]byte, error) {
...
func (o ReconEntityDataInnerRefundDetails) ToMap() (map[string]interface{}, error) {
