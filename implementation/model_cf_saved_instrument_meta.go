...
// GetCardSubType returns the CardSubType field value if set, zero value otherwise.
func (o *CFSavedInstrumentMeta) GetCardSubType() string {
	if o == nil || o.CardSubType == nil {
		var ret string
		return ret
	}
	return *o.CardSubType
}
...
func (o *CFSavedInstrumentMeta) HasCardSubType() bool {
	if o != nil && o.CardSubType != nil {
		return true
	}
...
// SetCardSubType gets a reference to the given string and assigns it to the CardSubType field.
func (o *CFSavedInstrumentMeta) SetCardSubType(v string) {
	o.CardSubType = &v
}
