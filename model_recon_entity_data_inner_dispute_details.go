...
// checks if the ReconEntityDataInnerDisputeDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReconEntityDataInnerDisputeDetails{}

// ReconEntityDataInnerDisputeDetails struct for ReconEntityDataInnerDisputeDetails
type ReconEntityDataInnerDisputeDetails struct {
...
func (o ReconEntityDataInnerDisputeDetails) MarshalJSON() ([]byte, error) {
...
func (o ReconEntityDataInnerDisputeDetails) ToMap() (map[string]interface{}, error) {
