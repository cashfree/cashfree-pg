...
func (_this *Cashfree) PGESReconVendor(vendorReconRequest *VendorReconRequest,  contentType *string, httpClient *http.Client) (*VendorRecon200Response, *http.Response, error) {
	var (
...
// Execute executes the request
//  @return VendorRecon200Response
func (_this *Cashfree) PGESReconVendorWithContext(ctx context.Context, vendorReconRequest *VendorReconRequest,  contentType *string, httpClient *http.Client) (*VendorRecon200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
