...
func (_this *Cashfree) PGESReconVendor(vendorReconRequest *VendorReconRequest,  xRequestId *string, xIdempotencyKey *string, contentType *string, httpClient *http.Client) (*VendorRecon200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *VendorRecon200Response
	)
	...
	if *_this.XEnableErrorAnalytics {
		...
		defer CaptureError("PGESReconVendor")
	}
	...
	localVarPath := localBasePath + "/recon/vendor"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if vendorReconRequest == nil {
		return localVarReturnValue, nil, reportError("vendorReconRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = vendorReconRequest
...
// Execute executes the request
//  @return VendorRecon200Response
func (_this *Cashfree) PGESReconVendorWithContext(ctx context.Context, vendorReconRequest *VendorReconRequest,  xRequestId *string, xIdempotencyKey *string, contentType *string, httpClient *http.Client) (*VendorRecon200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
