...
// checks if the ReconEntityDataInnerSettlementDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReconEntityDataInnerSettlementDetails{}

// ReconEntityDataInnerSettlementDetails struct for ReconEntityDataInnerSettlementDetails
type ReconEntityDataInnerSettlementDetails struct {
...
func (o ReconEntityDataInnerSettlementDetails) MarshalJSON() ([]byte, error) {
...
func (o ReconEntityDataInnerSettlementDetails) ToMap() (map[string]interface{}, error) {
