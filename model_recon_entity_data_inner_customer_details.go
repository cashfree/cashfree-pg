...
// checks if the ReconEntityDataInnerCustomerDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReconEntityDataInnerCustomerDetails{}

// ReconEntityDataInnerCustomerDetails struct for ReconEntityDataInnerCustomerDetails
type ReconEntityDataInnerCustomerDetails struct {
...
func (o ReconEntityDataInnerCustomerDetails) MarshalJSON() ([]byte, error) {
...
func (o ReconEntityDataInnerCustomerDetails) ToMap() (map[string]interface{}, error) {
