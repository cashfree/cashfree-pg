...
// checks if the ENACH type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ENACH{}

// ENACH payment method enach.
type ENACH struct {
	// Channel. can be link
...
func (o ENACH) MarshalJSON() ([]byte, error) {
...
func (o ENACH) ToMap() (map[string]interface{}, error) {
