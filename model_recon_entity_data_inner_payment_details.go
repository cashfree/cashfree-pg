...
// checks if the ReconEntityDataInnerPaymentDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReconEntityDataInnerPaymentDetails{}

// ReconEntityDataInnerPaymentDetails struct for ReconEntityDataInnerPaymentDetails
type ReconEntityDataInnerPaymentDetails struct {
...
func (o ReconEntityDataInnerPaymentDetails) MarshalJSON() ([]byte, error) {
...
func (o ReconEntityDataInnerPaymentDetails) ToMap() (map[string]interface{}, error) {
